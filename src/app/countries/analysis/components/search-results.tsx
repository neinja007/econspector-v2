				...
				.map((element) => (
					...
					>
						<div className='relative'>
							<div className='dark:brightness-50 brightness-75 group-hover:shadow-lg group-hover:brightness-100 dark:group-hover:brightness-100 aspect-4/3 transition-all rounded-md overflow-hidden'>
